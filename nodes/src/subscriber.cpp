...
class MinimalSubscriber : public rclcpp::Node
{
  public:
    ...
    {
      subscription_1 = this->create_subscription<std_msgs::msg::String>("topic_1", 1, std::bind(&MinimalSubscriber::topic_callback_1, this, _1));
            
      subscription_2 = this->create_subscription<std_msgs::msg::Int16>("topic_2", 1, std::bind(&MinimalSubscriber::topic_callback_2, this, _1));
